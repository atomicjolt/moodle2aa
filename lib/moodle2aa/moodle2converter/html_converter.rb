module Moodle2AA::Moodle2Converter
  class HtmlConverter
    ...
    def update_links(content)
      ...
      return content if html.children.size == 1 && html.children.first.is_a?(Nokogiri::XML::Text)
    ...
    def update_url(link)
      ...
      Moodle2AA::OutputLogger.logger.info "invalid url #{link} - #{e.message}"
      link
    end
    ...
    def file_link(moodle_path)
      ...
      Moodle2AA::OutputLogger.logger.info "invalid url #{moodle_path} - #{e.message}"
      nil
    end
    ...
    def lookup_cc_link(activity, id, anchor)
      case activity
        ...
        when 'forum'
          ...
          Moodle2AA::OutputLogger.logger.info(
