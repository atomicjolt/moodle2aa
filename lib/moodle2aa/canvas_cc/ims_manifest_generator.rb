module Moodle2AA::CanvasCC
  class ImsManifestGenerator
    ...
    def course_setting_resource(xml)
      course_setting_dir = Moodle2AA::CanvasCC::CartridgeCreator::COURSE_SETTINGS_DIR
      export_file = File.join(course_setting_dir, Moodle2AA::CanvasCC::CanvasExportWriter::CANVAS_EXPORT_FILE)
      course_setting_file = File.join(course_setting_dir, Moodle2AA::CanvasCC::CourseSettingWriter::COURSE_SETTINGS_FILE)
      module_meta_file = File.join(course_setting_dir, Moodle2AA::CanvasCC::ModuleMetaWriter::MODULE_META_FILE)
