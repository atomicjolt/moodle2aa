module Moodle2AA::CanvasCC::Models
  class Course
    ...
    def start_at
      Moodle2AA::CC::CCHelper.ims_datetime(@settings[:start_at]) if @settings[:start_at]
    end


    def conclude_at
      Moodle2AA::CC::CCHelper.ims_datetime(@settings[:conclude_at]) if @settings[:conclude_at]
    end
