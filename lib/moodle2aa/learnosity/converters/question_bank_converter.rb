module Moodle2AA::Learnosity::Converters
  class QuestionBankConverter
    ...
    def convert(categories)
      ...
      question_converter = Moodle2AA::Learnosity::Converters::QuestionConverter.new(@moodle_course, @html_converter)
      ...
      group_by_quiz_page = Moodle2AA::MigrationReport.group_by_quiz_page?
