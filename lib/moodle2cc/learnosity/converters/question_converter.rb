module Moodle2CC::Learnosity::Converters
  class QuestionConverter
    ...
    def convert_question(moodle_question)
      feature = Moodle2CC::Learnosity::Models::Feature.new
    ...
    def create_item(moodle_question: , 
      ...
      item = Moodle2CC::Learnosity::Models::Item.new
    ...
    def convert_from_override(moodle_question)
      ...
      qdata = Moodle2CC::Learnosity::Converters::Overrides.instance.get_override(oldreference)
