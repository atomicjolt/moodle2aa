    ...
    def convert_question(moodle_question)
      ...
      while true 
        ...
        while subquestion = embedded_questions[0]
          ...
          case 
          when currenttype == Moodle2CC::Moodle2::Models::Quizzes::MultichoiceQuestion
          ...
          when currenttype == Moodle2CC::Moodle2::Models::Quizzes::ShortanswerQuestion
          ...
          when currenttype == Moodle2CC::Moodle2::Models::Quizzes::NumericalQuestion
