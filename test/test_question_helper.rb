module TestQuestionHelper
  ...
  def multiple_choice_question!
    ...
    answer1 = Moodle2AA::Moodle::Question::Answer.new
    answer1.id = 123
    answer1.text = 'Ruby'
    answer1.fraction = 1
    answer1.feedback = 'Yippee!'

    answer2 = Moodle2AA::Moodle::Question::Answer.new
    answer2.id = 234
    answer2.text = 'CoffeeScript'
    answer2.fraction = 0.75
    answer2.feedback = 'Nope'

    answer3 = Moodle2AA::Moodle::Question::Answer.new
    answer3.id = 345
    answer3.text = 'Java'
    answer3.fraction = 0.25
    answer3.feedback = 'No way'

    answer4 = Moodle2AA::Moodle::Question::Answer.new
    answer4.id = 456
  ...
  def multiple_dropdowns_question!
    ...
    choice5 = Moodle2AA::Moodle::Question::Choice.new
    choice5.id = 5
