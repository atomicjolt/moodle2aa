...
class TestUnitCCWiki < MiniTest::Test
  ...
  def setup
    ...
    @wiki = Moodle2AA::CC::Wiki.new @mod
  end
  ...
  def test_it_converts_pages
    ...
    assert_equal Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-my-wiki.html', wiki.pages[0].href
    ...
    assert_equal Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-new-page.html', wiki.pages[1].href
    assert_equal 'i2eb0de275c9d8430f49bbf4cdf96286c', wiki.pages[0].identifier
  end
  ...
  def test_it_converts_summary_to_page_if_no_pages_exist
    ...
    assert_equal Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki.html', wiki.pages[0].href
  ...
  def test_it_creates_resource_in_imsmanifest
    ...
    assert_equal Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-link.html', resource.attributes['href'].value
    assert_equal 'ie8b2c8b5a9156a6994b13abae6b18da6', resource.attributes['identifier'].value

    file = resource.xpath(%{file[@href="#{Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER}/my-wiki-link.html"]}).first
    assert file

    resource = xml.root.xpath('resource[2]').first
    assert resource
    assert_equal 'webcontent', resource.attributes['type'].value
    assert_equal Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-my-wiki.html', resource.attributes['href'].value
    assert_equal 'i2eb0de275c9d8430f49bbf4cdf96286c', resource.attributes['identifier'].value

    file = resource.xpath(%{file[@href="#{Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER}/my-wiki-my-wiki.html"]}).first
    assert file
  end
  ...
  def test_it_creates_wiki_html
    ...
    html = Nokogiri::HTML(File.read(File.join(tmp_dir, Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-my-wiki.html')))
    assert html
    ...
    html = Nokogiri::HTML(File.read(File.join(tmp_dir, Moodle2AA::CC::CCHelper::CC_WIKI_FOLDER + '/my-wiki-link.html')))
    assert html
