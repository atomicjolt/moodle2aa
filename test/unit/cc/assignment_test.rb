...
class TestUnitCCAssignment < MiniTest::Test
  include TestHelper
  ...
  def setup
    ...
    @assignment = Moodle2AA::CC::Assignment.new @mod
  end
  ...
  def test_it_creates_assignment_html
    ...
    html = Nokogiri::HTML(File.read(File.join(tmp_dir, Moodle2AA::CC::CCHelper::CC_ASSIGNMENT_FOLDER, 'create-a-rails-site.html')))
