...
class TestUnitCanvasQuestionGroup < MiniTest::Test
  include TestHelper
  ...
  def test_it_has_an_id
    question_group = Moodle2AA::Canvas::QuestionGroup.new :id => 1
    assert_equal 1, question_group.id
  end

  def test_it_has_an_id_that_defaults_to_1
    question_group = Moodle2AA::Canvas::QuestionGroup.new
    assert_equal 1, question_group.id
  end
  ...
  def test_it_has_points_per_item
    question_group = Moodle2AA::Canvas::QuestionGroup.new :points_per_item => 2
  ...
  def test_it_has_a_question_bank
    ...
    question_group = Moodle2AA::Canvas::QuestionGroup.new :question_bank => question_bank
