...
describe Moodle2AA::Moodle2::Parsers::QuestionnaireParser do
  subject { Moodle2AA::Moodle2::Parsers::QuestionnaireParser.new(fixture_path(File.join('moodle2', 'backup'))) }
