...
describe Moodle2AA::Moodle2::Parsers::ForumParser do
  subject(:parser) { Moodle2AA::Moodle2::Parsers::ForumParser.new(fixture_path(File.join('moodle2', 'backup')))}
  ...
  it 'parses a moodle forum' do
    ...
    expect(forum.force_subscribe).to eq true
