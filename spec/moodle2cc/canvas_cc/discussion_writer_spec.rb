...
describe Moodle2AA::CanvasCC::DiscussionWriter do
  subject(:writer) { Moodle2AA::CanvasCC::DiscussionWriter.new(work_dir, discussion) }
  let(:work_dir) { Dir.mktmpdir }
  let(:discussion) {Moodle2AA::CanvasCC::Models::Discussion.new}
