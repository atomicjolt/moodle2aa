...
module Moodle2AA::Moodle2Converter::QuestionConverters
  describe RandomSAConverter do
    ...
    it 'converts random short answer questions into question groups' do
      moodle_question = Moodle2AA::Moodle2::Models::Quizzes::Question.create('randomsamatch')
      ...
      expect(converted_group.is_a?(Moodle2AA::CanvasCC::Models::QuestionGroup)).to be_truthy
